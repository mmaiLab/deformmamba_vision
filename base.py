...
class Trainer(Base):
    ...
    def get_optimizer(self, model):
        ...
        #     if 'offset_mask' in name:
        #         print (name)
        offset_mask_params = [p for name, p in model.named_parameters() if 'offset_mask' in name]
        other_params = [p for name, p in model.named_parameters() if 'offset_mask' not in name]
        optimizer = torch.optim.Adam([
                {'params':offset_mask_params, 'lr':cfg.lr/10000,'weight_decay':1e-2},
